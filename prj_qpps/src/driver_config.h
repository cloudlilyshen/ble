...
#define CONFIG_UART0_TX_DEFAULT_IRQHANDLER              FALSE        /*!< Enable/Disable UART0 TX Default IRQ Handler */
#define CONFIG_UART0_RX_DEFAULT_IRQHANDLER              FALSE        /*!< Enable/Disable UART0 RX Default IRQ Handler */
#define CONFIG_UART0_TX_ENABLE_INTERRUPT                FALSE        /*!< Enable/Disable(Polling) UART0 TX Interrupt */
