...
struct usr_env_tag
{
    uint16_t    led4_on_dur;
    uint16_t    led4_off_dur;
};
...
extern int app_timer_handler(ke_msg_id_t const msgid, void const *param, ke_task_id_t const dest_id, ke_task_id_t const src_id);
