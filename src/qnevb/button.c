...
void button_init(void)
{
    ...
    gpio_wakeup_config(MOTOR_RUN_ARRIVE_PIN, GPIO_WKUP_BY_LOW);
    gpio_enable_interrupt(MOTOR_RUN_ARRIVE_PIN);
    ...
    gpio_wakeup_config(LOCKED_PIN, GPIO_WKUP_BY_LOW);
    gpio_enable_interrupt(LOCKED_PIN);
}
