...
enum
{
    ...
    APP_SYS_MOTOR_IS_ARRIVED_TIMER,
    APP_SYS_ALARM_START_TIMER,
    APP_SYS_ALARM_ON_TIMER,
    APP_SYS_ALARM_OFF_TIMER,
    APP_SYS_ALARM_STOP_TIMER,
    
    APP_SYS_SENDDATA_TIMER,
    APP_SYS_UARTRX_TIMER,
    // for ancsc
