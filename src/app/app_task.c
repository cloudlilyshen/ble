...
const struct ke_msg_handler app_default_state[] =
{
    ...
    {APP_SYS_LED_4_TIMER,                   (ke_msg_func_t) app_led_timer_handler},
#if (!QN_EACI)
...
#endif
    {APP_SYS_MOTOR_IS_ARRIVED_TIMER,                (ke_msg_func_t) app_timer_handler},
    {APP_SYS_ALARM_START_TIMER,                (ke_msg_func_t) app_timer_handler},
    {APP_SYS_ALARM_ON_TIMER,                (ke_msg_func_t) app_timer_handler},
    {APP_SYS_ALARM_OFF_TIMER,                (ke_msg_func_t) app_timer_handler},
    {APP_SYS_ALARM_STOP_TIMER,                (ke_msg_func_t) app_timer_handler},

    {APP_SYS_OPEN_TIMER,                (ke_msg_func_t) app_timer_handler},
    {APP_SYS_CLOSE_TIMER,                (ke_msg_func_t) app_timer_handler},

    {APP_SYS_STOP_TIMER,                (ke_msg_func_t) app_timer_handler},



    {APP_SYS_SENDDATA_TIMER,                (ke_msg_func_t) app_SendData_timer_handler},
    {APP_SYS_UARTRX_TIMER,                  (ke_msg_func_t) app_UartRXTimeOut_timer_handler},
#endif
#endif
#endif
